...
|---|---|---|
| Unit ULOs and assessments | Public [Monash Handbook](https://handbook.monash.edu/2026/units/FIT3161?year=2026) | Import the selected Malaysia S1/S2 offering as a draft and require coordinator confirmation. Assessment rows without a matching published offering label are withheld with a warning. The Handbook may change, so retain the source URL, offering scope, and import snapshot. |
